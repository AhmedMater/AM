...
public enum AMI {
    ...
    ENM_002("AM-ENM-002: All Email AMNotification Configuration needed are found in the Property File"),
    ...
    IO_004("AM-IO-004: ''{0}'' of Code: ''{1}'' is changed successfully"),
    ...
    JMS_001("AM-JMS-001: Message ''{0}'' is sent to {1} Queue successfully"),
