...
/*  Created On : 19-Jan-2018 5:22:56 PM 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
CREATE TABLE `bus_arc_delete_log`
(
	...
	CONSTRAINT `PK_arc_delete_log` PRIMARY KEY (`log_id` ASC)
)

;

CREATE TABLE `bus_arc_new_log`
(
	`log_id` INT NOT NULL AUTO_INCREMENT,
	`category` VARCHAR(3) NOT NULL,
	`category_related_id` VARCHAR(30) NOT NULL,
	...
	CONSTRAINT `PK_arc_new_log` PRIMARY KEY (`log_id` ASC)
)

;

CREATE TABLE `bus_arc_update_attr_log`
(
	`log_id` INT NOT NULL AUTO_INCREMENT,
	...
	CONSTRAINT `PK_arc_update_attribute_log` PRIMARY KEY (`log_id` ASC)
)

;

CREATE TABLE `bus_arc_update_log`
(
	`log_id` INT NOT NULL,
	`category` VARCHAR(3) NOT NULL,
	`category_related_id` VARCHAR(30) NOT NULL,
	...
	CONSTRAINT `PK_arc_update_log` PRIMARY KEY (`log_id` ASC)
)
...
CREATE TABLE `bus_update_attribute_log`
(
	`log_id` INT NOT NULL AUTO_INCREMENT,
	`update_log_id` INT NOT NULL,
	`attribute` VARCHAR(50) NOT NULL,
...
ALTER TABLE `bus_arc_delete_log` 
 ADD CONSTRAINT `FK_arc_delete_log_category`
	FOREIGN KEY (`category`) REFERENCES `bus_category` (`category_id`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `bus_arc_new_log` 
 ADD CONSTRAINT `FK_arc_new_log_category`
	FOREIGN KEY (`category`) REFERENCES `bus_category` (`category_id`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `bus_arc_update_attr_log` 
 ADD CONSTRAINT `FK_arc_update_attribute_log`
	FOREIGN KEY (`update_log_id`) REFERENCES `bus_arc_update_log` (`log_id`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `bus_arc_update_log` 
 ADD CONSTRAINT `FK_arc_update_log_category`
	FOREIGN KEY (`category`) REFERENCES `bus_category` (`category_id`) ON DELETE Restrict ON UPDATE Restrict
;
...
ALTER TABLE `bus_update_attribute_log` 
...
ALTER TABLE `per_error` 
 ADD CONSTRAINT `FK_per_error_per_exec_log`
	FOREIGN KEY (`first_execution_log`) REFERENCES `per_exec_log` (`execution_log_id`) ON DELETE Restrict ON UPDATE Restrict
;
...
ALTER TABLE `per_fn_exec_log` 
 ADD CONSTRAINT `FK_per_fn_exec_log_per_exec_log`
...
ALTER TABLE `per_fn_log` 
 ADD CONSTRAINT `FK_per_fn_log_per_exec_log`
	FOREIGN KEY (`first_execution_log`) REFERENCES `per_exec_log` (`execution_log_id`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `per_info` 
 ADD CONSTRAINT `FK_per_info_per_exec_log`
	FOREIGN KEY (`first_execution_log`) REFERENCES `per_exec_log` (`execution_log_id`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `per_interface` 
 ADD CONSTRAINT `FK_per_interface_per_exec_log`
	FOREIGN KEY (`first_execution_log`) REFERENCES `per_exec_log` (`execution_log_id`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `per_phase` 
 ADD CONSTRAINT `FK_per_phase_per_exec_log`
	FOREIGN KEY (`first_execution_log`) REFERENCES `per_exec_log` (`execution_log_id`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `per_source` 
 ADD CONSTRAINT `FK_per_source_per_exec_log`
	FOREIGN KEY (`first_execution_log`) REFERENCES `per_exec_log` (`execution_log_id`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `per_thread` 
 ADD CONSTRAINT `FK_per_thread_per_exec_log`
	FOREIGN KEY (`first_execution_log`) REFERENCES `per_exec_log` (`execution_log_id`) ON DELETE Restrict ON UPDATE Restrict
;

ALTER TABLE `per_warn` 
 ADD CONSTRAINT `FK_per_warn_per_exec_log`
	FOREIGN KEY (`first_execution_log`) REFERENCES `per_exec_log` (`execution_log_id`) ON DELETE Restrict ON UPDATE Restrict
;
