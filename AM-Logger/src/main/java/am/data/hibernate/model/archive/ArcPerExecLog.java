 ...
 */
@Entity
@Table(name = "arc_per_exec_log")
public class ArcPerExecLog {
    private static final String ARGS_SEPARATOR = ";,;";

    @Id
    @Column(name = "arc_exec_log_id")
    ...
    public ArcPerExecLog() {
    }
    public ArcPerExecLog(String execLogID, FnLog fnLog, LogType type, Thread thread, Interface interfaceLog, Phase phase, Source source, Date execTimeStamp, Date execLogDate, String interfaceRelatedID, String fullMsg, String args, Boolean processed) {
    ...
    public void setExecLogID(String execLogID) {
        this.execLogID = execLogID;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ArcPerExecLog)) return false;

        ArcPerExecLog that = (ArcPerExecLog) o;
